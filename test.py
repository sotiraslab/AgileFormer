...
parser.add_argument('--exp_dir', type=str,
                    default='./trained_models', help='experiment_directory')
...
if __name__ == "__main__":
    base_dir = "/scratch/peijie.qiu"
    save_dir = join("/scratch/peijie.qiu/segm_visualization", args.dataset)
    ...
    from networks.agileFormer_2d import DeformUFormer2D as ViT_seg
    config = get_config("configs/dat_unet_base_2d_linear.yaml")
    ...
    ckpt_path = join(base_dir, "DeformUformer", "abaltion_DePatch_DeAttn_LinPatchExpand_base", args.dataset, "epoch_399.pth")
